...
def train_bpe(
  ...
  with Pool(processes=num_processes) as pool:
    print(f"Starting pre-tokenization with {num_processes} processes on {len(tasks)} chunks...")
    ...
    for chunk_counter in tqdm(results_iterator, total=len(tasks), desc="Processing chunks"):
